...
// Input:
// Output:
//	- name: Constant_54_0	type: float	shape: Shape{1024, 512}
...
// Input:
// Output:
//	- name: Constant_47_0	type: float	shape: Shape{1}
...
// Input:
// Output:
//	- name: Constant_48_0	type: float	shape: Shape{1}
...
// Input:
// Output:
//	- name: Constant_49_0	type: float	shape: Shape{1048576}
...
// Input:
// Output:
//	- name: Constant_46_0	type: float	shape: Shape{1024, 1024}
...
// Input:
// Output:
//	- name: Constant_40_0	type: float	shape: Shape{1}
...
// Input:
// Output:
//	- name: Constant_52_0	type: float	shape: Shape{1024, 512}
...
// Input:
// Output:
//	- name: Constant_41_0	type: float	shape: Shape{1048576}
...
// Input:
// Output:
//	- name: Constant_38_0	type: float	shape: Shape{1024, 1024}
...
// Input:
// Output:
//	- name: Constant_53_0	type: float	shape: Shape{512, 1024}
...
// Input:
// Output:
//	- name: Constant_57_0	type: float	shape: Shape{524288}
...
// Input:
// Output:
//	- name: Constant_55_0	type: float	shape: Shape{1}
...
// Input:
// Output:
//	- name: Constant_56_0	type: float	shape: Shape{1}
...
extern void QuantizeDot_float_float_float_float_float_float_float_float_float_cuda_QuantizeDot_42_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* __restrict__ input0,float* __restrict__ input1,float* __restrict__ input2,float* __restrict__ input3,float* __restrict__ input4,float* __restrict__ input5,float* __restrict__ input6,float* __restrict__ input7, float* __restrict__ output0) {
    QuantizeDot_float_float_float_float_float_float_float_float_float_cuda_QuantizeDot_42<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, input7, output0);
}
...
CUDA_SAFE_CALL(cudaSetDevice(0));
CUDA_SAFE_CALL(cudaMalloc((void**)&group_persist_CUDA_GPU0_allocator_memory_pool,52449920));
CUDA_SAFE_CALL(cudaMemset((void*)group_persist_CUDA_GPU0_allocator_memory_pool, 0, 52449920));
Constant_7_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+0);
Constant_41_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+20480);
Constant_40_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+4214784);
Constant_39_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+4214848);
Constant_38_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+4214912);
Constant_37_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+8409216);
Constant_36_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+12603520);
Constant_35_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+16797824);
Constant_33_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+20992128);
Constant_32_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+20992192);
Constant_49_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+20992256);
Constant_48_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+25186560);
Constant_47_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+25186624);
Constant_46_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+25186688);
Constant_45_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+29380992);
Constant_44_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+33575296);
Constant_43_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+37769600);
Constant_57_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+41963904);
Constant_56_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+44061056);
Constant_55_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+44061120);
Constant_54_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+44061184);
Constant_53_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+46158336);
Constant_52_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+48255488);
Constant_51_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+50352640);
Constant_6_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+52449792);
Constant_27_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+52449856);
...
// Output:
//	- name: Add_25_0	type: float	shape: Shape{1024, 512}
extern "C" __global__  void QuantizeDot_float_float_float_float_float_float_float_float_float_cuda_QuantizeDot_58(float* __restrict__ input0,float* __restrict__ input1,float* __restrict__ input2,float* __restrict__ input3,float* __restrict__ input4,float* __restrict__ input5,float* __restrict__ input6,float* __restrict__ input7, float* __restrict__ output0)
{
    {
        const unsigned int M_GLOBAL=1024;
        ...
        const float scale_s1s2 = (float)(*input5);       // new modification, for s1 * s2
...
extern void QuantizeDot_float_float_float_float_float_float_float_float_float_cuda_QuantizeDot_58_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* __restrict__ input0,float* __restrict__ input1,float* __restrict__ input2,float* __restrict__ input3,float* __restrict__ input4,float* __restrict__ input5,float* __restrict__ input6,float* __restrict__ input7, float* __restrict__ output0) {
    QuantizeDot_float_float_float_float_float_float_float_float_float_cuda_QuantizeDot_58<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, input7, output0);
}
...
cudaFuncSetAttribute(
   QuantizeDot_float_float_float_float_float_float_float_float_float_cuda_QuantizeDot_42 , cudaFuncAttributeMaxDynamicSharedMemorySize,65536);
cudaFuncSetAttribute(
   QuantizeDot_float_float_float_float_float_float_float_float_float_cuda_QuantizeDot_58 , cudaFuncAttributeMaxDynamicSharedMemorySize,65536);
cudaFuncSetAttribute(
...
BitConverter_float_float_float_float_cuda_BitConverter_34_Call(dim3(32, 32, 1), dim3(32, 32, 1), 65536, 0, Reshape_10_0, Constant_32_0, Constant_33_0, BitConverter_34_0);
 // name=QuantizeDot_42
QuantizeDot_float_float_float_float_float_float_float_float_float_cuda_QuantizeDot_42_Call(dim3(68, 1, 1), dim3(256, 1, 1), 65536, 0, BitConverter_34_0, Constant_35_0, Constant_36_0, Constant_37_0, Constant_38_0, Constant_39_0, Constant_40_0, Constant_41_0, Add_15_0);
 // name=QuantizeDot_50
QuantizeDot_float_float_float_float_float_float_float_float_float_cuda_QuantizeDot_42_Call(dim3(68, 1, 1), dim3(256, 1, 1), 65536, 0, Add_15_0, Constant_43_0, Constant_44_0, Constant_45_0, Constant_46_0, Constant_47_0, Constant_48_0, Constant_49_0, Add_20_0);
 // name=QuantizeDot_58
QuantizeDot_float_float_float_float_float_float_float_float_float_cuda_QuantizeDot_58_Call(dim3(68, 1, 1), dim3(256, 1, 1), 65536, 0, Add_20_0, Constant_51_0, Constant_52_0, Constant_53_0, Constant_54_0, Constant_55_0, Constant_56_0, Constant_57_0, Add_25_0);
 // name=Dot_26
