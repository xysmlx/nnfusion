...
#include "quantizeconv1x1.hpp"

using namespace std;
using namespace nnfusion::op;


QuantizeConv1x1::QuantizeConv1x1(size_t quantize_bit)
    : Op("QuantizeConv1x1")
...
void QuantizeConv1x1::validate_and_infer_types(std::shared_ptr<graph::GNode> gnode)
{
